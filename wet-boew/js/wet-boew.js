 ...
 * v4.0.23-development - 2016-10-17
 *
...
var componentName = "wb-disable",
    ...
    init = function( event ) {
        ...
        if ( elm ) {
            ...
            // element for standard link (NEW)
            div = document.createElement( "div" );
            div.className = "wb-slc";

            // element for basic link
            ...
            try {
                if ( wb.isDisabled || ( wb.ie && wb.ielt7 ) ) {
                    ...
                    // Append the Standard version link (NEW)
                    div.innerHTML = "<p id='wbdisable-bnr'>" + i18n( "wb-basic-warning" ) + " <a href='" + nQuery + "wbdisable=false'>" + i18n( "wb-enable" ) + "</a></p>";

                    // Add link to re-enable WET plugins and polyfills (NEW)
